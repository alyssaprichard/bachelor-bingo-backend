...
const CLICHES = [
    ...
    "Tears during individual interviews",
    ...
    "Mel says chemistry or connection",
    "Flashback clip to a previous date",
    "Flashback to limo entrance",
    "Audience gasps loudly",
    "A woman says she wants authenticity",
    "Someone real",
    ...
    "A contestant jokes about hot flashes",
    "A contestant jokes about memory loss",
    ...
    "A contestant says she's dating again",
    "A contestant says she met someone new",
    "Audience chants or claps mid-argument",
    "A villain contestant gets applause",
    "A villain contestant gets redemption moment",
    "Mel says you're an amazing woman",
    "Someone says I have no regrets",
    "Jesse Palmer makes a joke that's cheesy",
    "Jesse Palmer makes a joke that doesn't land",
